...
import { Shield, Zap, Share2, ArrowRight, Lock } from 'lucide-react';
...
const steps = [
  {
    step: '01 / 03',
    title: ['Track your daily ', <em key="s" className="not-italic text-primary">spending</em>, ' effortlessly'],
    description: "PesaGuard processes M-Pesa messages you share to automatically track every transaction — no SMS permissions needed.",
  },
  {
    step: '02 / 03',
  ...
  {
    step: '03 / 03',
    title: ['Just share your ', <em key="m" className="not-italic text-primary">M-Pesa</em>, ' messages'],
    description: 'Open your SMS app → long-press an M-Pesa message → tap Share → select PesaGuard. That\'s it!',
  },
];
      ...
      <div className="min-h-screen flex flex-col bg-background">
        <div className="flex-1 px-6 pt-16 pb-8">
          ...
          <h1 className="text-4xl font-bold text-foreground mt-4 leading-tight">
            Share M-Pesa messages <span className="text-primary">privately</span>
          </h1>
          <p className="text-base text-muted-foreground mt-4 leading-relaxed">
            PesaGuard never reads your SMS directly. You choose which messages to share — your privacy is fully in your control.
          </p>
          ...
          <div className="mt-8 space-y-5">
            <div className="flex gap-3">
              ...
              <div>
                <p className="font-bold text-sm text-foreground">Share from SMS App</p>
                <p className="text-sm text-muted-foreground mt-0.5">Open your SMS app, long-press an M-Pesa message, tap Share, and select PesaGuard.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="font-bold text-sm text-foreground">Auto-Categorized</p>
                <p className="text-sm text-muted-foreground mt-0.5">PesaGuard parses the amount, type, and name — then lets you pick a category.</p>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="font-bold text-sm text-foreground">100% Private</p>
                <p className="text-sm text-muted-foreground mt-0.5">No SMS permissions. No data uploaded. Everything stays on your device.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-muted rounded-t-3xl px-6 py-8 border-t-4 border-primary">
          ...
          <h2 className="text-xl font-bold text-foreground text-center">Ready to Start</h2>
          <p className="text-sm text-muted-foreground text-center mt-2">
            No permissions needed! Just share your M-Pesa messages whenever you want to track them.
          </p>
          <button
            onClick={onComplete}
          ...
          <p className="flex items-center justify-center gap-1 text-[10px] text-muted-foreground mt-4 tracking-widest uppercase">
            <Lock className="w-3 h-3" /> No SMS permissions required
          </p>
        </div>
      </div>
    );
      ...
      <div className="mx-6 mt-4 h-56 rounded-3xl flex items-center justify-center" style={{ background: 'var(--gradient-dark)' }}>
        <div className="text-center">
          <div className="bg-card/20 backdrop-blur rounded-2xl p-4 inline-block">
            ...
            <p className="text-primary-foreground text-2xl font-bold">Share & Track</p>
            <p className="text-primary/80 text-xs mt-1">No permissions needed</p>
          </div>
        </div>
      </div>
